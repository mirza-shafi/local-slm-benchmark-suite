      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
          <div className="p-6 bg-white rounded-lg shadow-md border border-gray-200">
            ...
            <h3 className="text-xl font-bold mb-2 text-gray-800">Full Privacy</h3>
          ...
          <div className="p-6 bg-white rounded-lg shadow-md border border-gray-200">
            <div className="text-3xl mb-3">⚡</div>
            <h3 className="text-xl font-bold mb-2 text-gray-800">Real Metrics</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md border border-gray-200">
            <div className="text-3xl mb-3">💰</div>
            <h3 className="text-xl font-bold mb-2 text-gray-800">Cost Analysis</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md border border-gray-200">
            <div className="text-3xl mb-3">📊</div>
            <h3 className="text-xl font-bold mb-2 text-gray-800">Side-by-Side Comparison</h3>
            <p className="text-gray-600">
        ...
        {/* Supported Models */}
        <div className="mb-12 p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-200">
          <h2 className="text-2xl font-bold mb-4 text-gray-800">📦 Supported Models</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <h4 className="font-bold text-gray-800 mb-1">⚡ TinyLlama-1.1B</h4>
              <p className="text-sm text-gray-600">Fastest, minimal memory</p>
            </div>
            <div>
              <h4 className="font-bold text-gray-800 mb-1">⚙️ Phi-2</h4>
              <p className="text-sm text-gray-600">Balanced speed & quality</p>
            </div>
            <div>
              <h4 className="font-bold text-gray-800 mb-1">🎯 Mistral-7B</h4>
              <p className="text-sm text-gray-600">Best quality reasoning</p>
            </div>
          </div>
        </div>
